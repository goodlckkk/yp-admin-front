export const Icons = {
  Microscope: ({ className = "w-6 h-6" }: { className?: string }) => (
  ...
  Star: ({ className = "w-6 h-6", filled = false }: { className?: string; filled?: boolean }) => (
  ...
  RefreshCw: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M21 2v6h-6M3 22v-6h6M21 12a9 9 0 01-15.55 6.37L3 16m18-4a9 9 0 00-15.55-6.37L3 8"
      />
    </svg>
  ),
  ...
  Bell: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M15 17h5l-5 5v-5zM4.868 12.683A17.925 17.925 0 0112 21c7.962 0 12-7.962 12-9.207 0-.895-.155-1.744-.463-2.53M4.868 12.683a18.15 18.15 0 002.773-4.41A18.15 18.15 0 0012 3c1.63 0 3.162.214 4.615.588M9.077 9.077a6 6 0 118.846 0M9.077 9.077a6 6 0 108.846 8.846"
      />
    </svg>
  ),
  ...
  Image: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Save: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  MessageCircle: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
